...
SEED=$(update_seed $SEED)
python3 ExperimentAlt.py --save_fig --progress_bar -exp HSIC -n 800 -e 0.3 -s $SEED  -t 

SEED=$(update_seed $SEED)
python3 ExperimentAlt.py --save_fig --progress_bar -exp HSIC -n 500 -e 0.35 -s $SEED -t 



SEED=$(update_seed $SEED)
python3 ExperimentAlt.py --save_fig --progress_bar -exp HSIC -k RationalQuadratic -n 800 -e 0.3 -s $SEED  -t 

SEED=$(update_seed $SEED)
python3 ExperimentAlt.py --save_fig --progress_bar -exp HSIC -k RationalQuadratic -n 500 -e 0.35 -s $SEED  -t 




SEED=$(update_seed $SEED)
python3 ExperimentAlt.py --save_fig --progress_bar -exp dCov -n 800 -e 0.3 -s $SEED  -t 

SEED=$(update_seed $SEED)
python3 ExperimentAlt.py --save_fig --progress_bar -exp dCov -n 500 -e 0.35 -s $SEED  -t 
