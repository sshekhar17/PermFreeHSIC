...
SEED=$(update_seed $SEED)
python3 ExperimentAlt.py --save_fig --progress_bar -exp HSIC -n 400 -e 0.5 -s $SEED -t

SEED=$(update_seed $SEED)
python3 ExperimentAlt.py --save_fig --progress_bar -exp HSIC -n 800 -e 0.4 -s $SEED  -t

SEED=$(update_seed $SEED)
python3 ExperimentAlt.py --save_fig --progress_bar -exp HSIC -n 1200 -e 0.3 -s $SEED -t


SEED=$(update_seed $SEED)
python3 ExperimentAlt.py --save_fig --progress_bar -exp HSIC -k RationalQuadratic -n 400 -e 0.5 -s $SEED  -t

SEED=$(update_seed $SEED)
python3 ExperimentAlt.py --save_fig --progress_bar -exp HSIC -k RationalQuadratic -n 800 -e 0.4 -s $SEED  -t

SEED=$(update_seed $SEED)
python3 ExperimentAlt.py --save_fig --progress_bar -exp HSIC -k RationalQuadratic -n 1200 -e 0.3 -s $SEED  -t
